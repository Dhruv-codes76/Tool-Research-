...
const toolDataMap: Record<string, ToolData> = {
  ghostty: {
    ...
    about: 'Ghostty is a highly-optimized terminal emulator designed for modern workflows. Built with native performance in mind, it provides smooth rendering, low latency, and advanced feature sets without compromising on resource usage.\n\nEnjoy extensive configuration options, custom keybindings, multi-window support, and deeply integrated system APIs that make Ghostty feel like a natural extension of your operating system.',
    ...
    <main className="max-w-[1280px] mx-auto px-4 md:px-6 pt-24 pb-12">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          {/* Hero Section */}
          <div 
            className="relative rounded-xl overflow-hidden aspect-[16/9] lg:aspect-auto lg:h-[220px] mb-8 border border-outline-variant"
